...
mod tests {
    ...
    fn verify_imdct12_win() {
        const TEST_VECTOR: [f32; 18] = [
            0.0976, 0.9321, 0.6138, 0.0857, 0.0433, 0.4855, 0.2144, 0.8488, 0.6889, 0.2983, 0.1957,
            0.7037, 0.0052, 0.0197, 0.3188, 0.5123, 0.2994, 0.7157,
        ];
...
mod imdct36 {
    ...
    mod tests {
        ...
        fn verify_imdct36() {
            const TEST_VECTOR: [f32; 18] = [
                0.0976, 0.9321, 0.6138, 0.0857, 0.0433, 0.4855, 0.2144, 0.8488, 0.6889, 0.2983,
                0.1957, 0.7037, 0.0052, 0.0197, 0.3188, 0.5123, 0.2994, 0.7157,
            ];
