...
converter!(
    ...
    i24,
    s,
    (((s.into_i32() as u32).wrapping_add(0x80_0000) & 0xff_ffff) >> 16) as u8
);
converter!(
    u8,
    i32,
    s,
    ((s as u32).wrapping_add(0x8000_0000) >> 24) as u8
);
converter!(u8, f32, s, {
...
converter!(
    ...
    i24,
    s,
    (((s.into_i32() as u32).wrapping_add(0x80_0000) & 0xff_ffff) >> 8) as u16
);
converter!(
    u16,
    i32,
    s,
    ((s as u32).wrapping_add(0x8000_0000) >> 16) as u16
);
converter!(u16, f32, s, {
...
converter!(
    ...
    i8,
    s,
    u24::from(u32::from((s as u8).wrapping_add(0x80)) << 16)
);
converter!(
    u24,
    i16,
    s,
    u24::from(u32::from((s as u16).wrapping_add(0x8000)) << 8)
);
converter!(
    u24,
    i24,
    s,
    u24::from((s.into_i32() as u32).wrapping_add(0x80_0000) & 0xff_ffff)
);
converter!(
    u24,
    i32,
    s,
    u24::from((s as u32).wrapping_add(0x8000_0000) >> 8)
);
converter!(u24, f32, s, {
...
converter!(
    ...
    i16,
    s,
    u32::from((s as u16).wrapping_add(0x8000)) << 16
);
converter!(
    u32,
    i24,
    s,
    ((s.into_i32() as u32).wrapping_add(0x80_0000) & 0xff_ffff) << 8
);
...
converter!(
    ...
    u24,
    s,
    (s.into_u32().wrapping_add(0x80_0000) >> 16) as i8
);
...
converter!(
    ...
    u24,
    s,
    (s.into_u32().wrapping_add(0x80_0000) >> 8) as i16
);
...
converter!(
    ...
    f32,
    s,
    clamp_i16((clamp_f32(s) * 32_768.0).round() as i32)
);
converter!(
    i16,
    f64,
    s,
    clamp_i16((clamp_f64(s) * 32_768.0).round() as i32)
);
...
converter!(
    ...
    u24,
    s,
    i24::from((s.into_u32() & 0xff_ffff) as i32 - 0x80_0000)
);
converter!(
    i24,
    u32,
    s,
    i24::from((s.wrapping_add(0x8000_0000) as i32) >> 8)
);
...
converter!(
    ...
    f32,
    s,
    i24::from(clamp_i24((clamp_f32(s) * 8_388_608.0).round() as i32))
);
converter!(
    i24,
    f64,
    s,
    i24::from(clamp_i24((clamp_f64(s) * 8_388_608.0).round() as i32))
);
...
converter!(
    ...
    u24,
    s,
    ((s.into_u32() & 0xff_ffff) as i32 - 0x80_0000) << 8
);
...
converter!(
    ...
    f32,
    s,
    clamp_i32((clamp_f32(s) * 2_147_483_648.0).round() as i64)
);
converter!(
    i32,
    f64,
    s,
    clamp_i32((clamp_f64(s) * 2_147_483_648.0).round() as i64)
);
...
converter!(
    ...
    u24,
    s,
    (i24::from_sample(s).into_i32() as f32) / 8_388_608.0
);
...
converter!(
    ...
    u24,
    s,
    f64::from(i24::from_sample(s).into_i32()) / 8_388_608.0
);
converter!(
    f64,
    u32,
    s,
    f64::from(i32::from_sample(s)) / 2_147_483_648.0
);
