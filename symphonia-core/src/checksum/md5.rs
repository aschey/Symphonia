...
mod tests {
    ...
    fn verify_md5() {
        ...
        const HASHES: [[u8; 16]; 8] = [
            ...
            [
                0x64, 0x1b, 0xa6, 0x02, 0x88, 0xc1, 0x7a, 0x2d, 0xa5, 0x09, 0x00, 0x77, 0xeb, 0x89,
                0x58, 0xad,
            ],
            [
                0x0a, 0x71, 0xdb, 0x4d, 0xf3, 0x50, 0x92, 0x73, 0x62, 0x42, 0x3a, 0x42, 0xdc, 0xf8,
                0x14, 0x57,
            ],
            [
                0x0b, 0x76, 0x74, 0x7e, 0xfd, 0xcd, 0xb9, 0x33, 0x67, 0xfe, 0x2d, 0xa3, 0x21, 0x1b,
                0x5d, 0x41,
            ],
        ];
